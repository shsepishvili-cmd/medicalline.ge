...
// 1. გაზიარების მეტამონაცემები (Facebook / SEO)
export const metadata = {
  ...
  openGraph: {
    ...
    url: 'https://medicalline.ge/blog/intraoraluri-skaneri-vs-anabechdi', // 👈 ამ პოსტის უნიკალური ლინკი
    siteName: 'Medical Line Georgia',
    images: [
      {
        url: 'https://medicalline.ge/images/finscan.png', // ❗️ სრული ლინკი Facebook-ისთვის
        width: 1200,
        height: 630,
...
export default function BlogComparison() {
  // 2. ტყუილი ნახვების გენერატორი: საბაზისო 4120-ს + ემატება 1-დან 200-მდე შემთხვევითი რიცხვი ყოველ შემოსვლაზე
  const fakeViews = 4120 + Math.floor(Math.random() * 200);
