export const products = [
  ...
  },
  {
    ...
    name: "Aurora ???????????",
    img: "/images/aurora-endofiles.png",
    cat: "??????????",
    description: "Aurora Series ??????????? ???? ?????-??????? ????????? ???????? ??????? ????? ??????????? ?? ???????????????. ????? ??????? Super Flexi, R-Shaper ?? Sup-Taper ??????? ?????????? ????????? ????????????.",
    specs: [
      "Super Flexi Files ??????? ???????????",
      "R-Shaper ??????? ???????? shaping workflow-?????",
      "Sup-Taper Files ?????????? ???????? ????? ??????????????",
      "Heat activated NiTi ?? nano coating",
      "25?? ??????; 6 ???? ?????????"
    ],
    aiFeatures: [
      { icon: 'zap', title: 'Flexible NiTi', desc: '???????? ???????????? NiTi ???????? ?????? ??????? ???????? ????????.' },
      { icon: 'shield', title: 'System Workflow', desc: 'Super Flexi, R-Shaper ?? Sup-Taper ??????? ?????? glide path-?, shaping-? ?? taper finishing-?.' }
    ]
  },
