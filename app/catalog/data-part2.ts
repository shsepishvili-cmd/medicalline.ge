export const products = [
  ...
  },
  {
    id: 34,
    slug: "le-ray-w",
    name: "LifeDent Le Ray W პორტატული რენტგენი",
    img: "/images/le-ray-w.jpg",
    cat: "რადიოლოგია",
    description: "LifeDent Le Ray W არის პორტატული დენტალური რენტგენის აპარატი მაღალი სიხშირის DC გენერატორით, 4.3 ინჩიანი ფერადი სენსორული ეკრანით და სტაბილური გამოსახულებით ყოველდღიური ინტრაორალური დიაგნოსტიკისთვის.",
    specs: [
      "პორტატული კონსტრუქცია მოქნილი პოზიციონირებისთვის",
